...
def handle_client(client_socket, client_address):
    ...
    client_recieve_key = RSA.import_key(client_socket.recv(2048))
    aes_key = get_random_bytes(16)
    
    cipher_rsa = PKCS1_OAEP.new(client_recieve_key)
    ...
    while True:
        ...
        print(f"Recieved from {client_address} : {encrypted_message} message: {decrypted_message}")
